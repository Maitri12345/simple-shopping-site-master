...
<div class="topnav" id="myTopnav">
 ...
 <div style="float:right;"> 
  ...
  <?php if(isset($_SESSION['uname'])===TRUE){ ?>
		...
		<u><h3 ><font color="White">Hello </font><font color="yellow"><?php if(isset($_SESSION['uname'])){echo $_SESSION['uname'];} else if(isset($_SESSION['seller'])){echo $_SESSION['seller'];} ?></font></h3></u>
